...
import community from "assets/images/cent.gif"
import { CypherTheme } from "styles/ColorStyles"
import { Header6 } from "styles/TextStyles"
    ...
    <>
      <Body>
        <Cover>
          ...
          <Title>
            The project’s Origin Group has carefully developed a two-year
            roadmap of activities, that will ultimately turn the Legends of
            Cypher into a global community-driven universe.
          </Title>
          <Title>
            Join our Discord to learn more about the project and start taking
...
const Title = styled(Header6)`
  ...
  text-align: left;
`
const ImageCompCover = styled.div`
  min-height: 250px;
  max-height: 739px;
  height: 100%;
  max-width: 1312px;
